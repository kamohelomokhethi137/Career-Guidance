...
import { 
  FaHome, FaUniversity, FaBookOpen, FaUsers, FaBriefcase, 
...
const Sidebar = () => {
  ...
  const navItems = [
    ...
    { name: "Institutions", icon: <FaUniversity />, path: "/admin/institutions" },
    { name: "Faculties & Courses", icon: <FaBookOpen />, path: "/admin/courses" },
    { name: "Users", icon: <FaUsers />, path: "/admin/users" },
    { name: "Companies", icon: <FaBriefcase />, path: "/admin/companies" },
